...
- **Next:** sandboxed smoke-run of the installed entrypoint; GitHub release assets once a published digest can be verified; dependency resolution (today only the named package is installed).
## M23 - Study Abroad
