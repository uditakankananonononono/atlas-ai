...
def test_235_280_distinct_review_envelopes():
 a=workbench('admm',{'source':SRC,'objective':[1.0,2.0],'initial':[0.0,0.0],'constraint_matrix':[[1.0,0.0],[0.0,1.0]],'bounds':[1.0,1.0]});b=workbench('dialogue_writing',{'source':SRC,'premise':'Two rivals cooperate','scenes':[{'text':'Two rivals cooperate','character':'A','goal':'trust','tension':0.7,'duration':2,'location':'lab'}]})
