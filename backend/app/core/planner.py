...
def plan_goal(goal: str, allow_external_action: bool = False, *, user_id: str = "default") -> GoalPlan:
    text = goal.lower()
    ...
    approvals = [approval_store.put(request, user_id=user_id) for request in approvals]
