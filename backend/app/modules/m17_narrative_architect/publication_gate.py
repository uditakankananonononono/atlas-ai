...
def publish_through_gate(body:PublicationGateRequest,adapter:PublicationAdapter)->dict:
 if not body.reviewed_by_owner:raise ValueError('owner review is required before publication')
 if not body.disclosure_approved:raise ValueError('disclosure approval is required for this audience boundary')
