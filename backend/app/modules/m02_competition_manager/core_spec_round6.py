"""Executable core-spec capabilities for audit rows owned by module 2.
...
ROWS: dict[int, str] = {
    46: 'GPT-4o rules summary then structured JSON',
    47: 'eligibility_criteria/required_materials/deadlines/evaluation_criteria storage',
    48: 'Checklist from materials',
    49: 'Automatic subtasks and deadline propagation',
    50: 'Terms and conditions analysis',
    51: 'Scoring rubric analysis',
    52: 'Connections among previous winners',
    53: 'Winner/conductor social-tip videos',
    54: 'Host values analysis',
    57: 'Chrome/form-filler integration',
    58: 'Google Docs activity grounding',
    60: 'Email officials for advice/pointers',
    61: 'Routine post-submission follow-up',
    62: 'Few-shot successful-application drafting',
    63: 'Retrieve snippets from past projects',
    64: 'Knowledge Workspace + user review queue',
    65: 'Browser form fill + screenshot + final approval',
    66: 'Email confirmation/status parsing',
    67: 'Judging-announcement monitoring',
    69: 'RippleMatch',
    70: 'Simplify',
    71: 'RaiseMe',
    72: 'Bold.org',
    73: 'Fastweb',
    74: 'Devpost alerts/discovery',
    75: 'ChallengeRocket'
}
...
def execute(row:int, request:CapabilityRequest) -> CapabilityResult:
    if row not in ROWS:
        raise KeyError(f"unsupported module-2 core-spec row: {row}")
    ...
    artifact={
      "id":f"m2-r{row}-{digest[:12]}", "objective":objective,
...
router=APIRouter(prefix="/core-spec",tags=["Module 2 core spec"])
