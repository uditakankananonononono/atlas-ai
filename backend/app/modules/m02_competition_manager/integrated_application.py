...
class IntegratedApplicationFlow:
 ...
 async def prepare(self,competition_id,official_url,fields,provider='openai'):
  exact={};provenance={};evidence_inputs={}
  for field in fields:
   ...
   evidence_inputs[field['field']]={'draft':drafted['draft'],'sources':hits}
  ...
  package.update({'evidence_completeness':score_package(evidence_inputs),'official_url':official_url,'source_provenance':provenance,'browser_stage_path':'/api/v1/competition-manager/competitions/{competition_id}/form-fill-proposals','final_submit_requires_separate_approval':True})
  return package
