...
def run(method:str,data:dict,params:dict|None=None,seed:int=0)->dict:
    ...
    if method in climate_environment.ROWS:return climate_environment.run(method,data,params,seed)
    if method in ai_systems.ROWS:return ai_systems.run(method,data,params,seed)
    if method in emerging.ROWS:return emerging.run(method,data,params,seed)
