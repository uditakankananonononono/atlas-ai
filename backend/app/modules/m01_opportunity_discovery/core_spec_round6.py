"""Executable core-spec capabilities for audit rows owned by module 1.
...
ROWS: dict[int, str] = {
    ...
    11: 'Twitter/X lists',
    12: 'Reddit r/competitions and r/scholarships',
    15: 'Girls on Campus',
    16: 'Institute of Competition Sciences',
    17: 'Bold.org',
    18: 'Unigo',
    19: 'Fastweb',
    20: 'JoinSucceed',
    21: 'Named college/company Instagram channels',
    22: 'Tata Imagination Challenge',
    23: 'Samsung Solve for Tomorrow',
    24: 'Google opportunities',
    25: 'Scholarships360',
    26: 'Scholarships.com',
    27: 'Exactly 200 scholarship sites',
    30: 'Scholarship/competition/CS/life/business/research/science/event/hackathon/essay/study-abroad topics',
    31: '10,000+ keywords',
    32: '500,000 accounts per platform',
    33: 'Business ideas/problems/ventures/tools/inventions/discoveries',
    34: 'Ivies/T50/global top schools',
    35: 'Admissions advice/pages/labs/clubs/events/counsellors/sponsored trips/youth backing/olympiads/projects',
    36: 'Neatly compiled and organized',
    37: 'Ask user to log into Google/Instagram/other accounts',
    38: 'Celery Beat hourly crawls',
    39: 'Playwright dynamic pages',
    40: 'BeautifulSoup static HTML',
    41: 'spaCy entity extraction',
    42: 'dateparser date parsing',
    45: 'Video/image/text understanding'
}
...
def execute(row:int, request:CapabilityRequest) -> CapabilityResult:
    if row not in ROWS:
        raise KeyError(f"unsupported module-1 core-spec row: {row}")
...
router=APIRouter(prefix="/core-spec",tags=["Module 1 core spec"])
