...
export type RerunProposalRow={schedule_id:string;original_approval_id:string;rerun_approval_id:string;state:string;filed_at:string;age_hours:number;overdue:boolean;verdict:string|null};
